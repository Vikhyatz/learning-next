    ...
    return (
        <div className='flex justify-center items-center w-full h-screen overflow-hidden bg-[#313338] flex-col '>
            <div className="w-[80%] max-w-[550px] justify-center items-center flex-col p-[5%] text-center">
                <p className="w-full text-white font-bold text-[30px]">Register to Discord</p>
                ...
                <form className="flex items-center justify-center flex-col w-full gap-[10px]" action="/login" method="post">
                    <input type="email" name="email" placeholder="Enter your username" className="w-full h-[50px] rounded-[5px] border-[1px] border-solid border-[#302d2d] bg-[#1e1f22] p-[10px] text-white outline-0 duration-[0.5s] focus:border-1px focus:border-solid focus:border-[#5865f2] focus:placeholder:text-[#5865f2] text-[14px]" required autocomplete="off" />
                    <input type="text" name="username" placeholder="Enter your email" className="w-full h-[50px] rounded-[5px] border-[1px] border-solid border-[#302d2d] bg-[#1e1f22] p-[10px] text-white outline-0 duration-[0.5s] focus:border-1px focus:border-solid focus:border-[#5865f2] focus:placeholder:text-[#5865f2] text-[14px]" required autocomplete="off" />
                ...
                <div className="flex justify-start w-full mt-[15px] text-[#949ba4] text-[13px] bg-[#ff000000]">
                    ...
                    <Link className='text-[#00a8fc]' href="/"> login </Link>
                </div>
            </div>
        </div>
    )
