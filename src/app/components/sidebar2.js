import NavSubTabs from './navSubTabs'
...
export default function Sidebar2 () {
    return (
        <div id="serverNav" className='w-[240px] h-screen bg-[#2B2D31] flex items-center flex-col relative'>
                ...
                <p className="w-[200px] text-[#949ba4] text-[13px] font-bold px-[10px] pt-[20px] pb-[10px] cursor-default mb-[10px] border-b-[1.5px] border-b-[#131313] border-b-[solid] hover:text-white">DIRECT MESSAGES</p>
